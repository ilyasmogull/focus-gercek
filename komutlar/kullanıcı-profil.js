...
exports.run = async (bot, msg, args) => {
        ...
        .replace("dnd", `<:kapali:756096841367420989>  | **Rahatsız Etmeyin**`)
        .replace("online", `<:acik:756097249133723668>  | **Çevrimiçi**`)
        .replace("idle", `<:bosta:761983003660255263>  | **Boşta**`)
        .replace("offline", `<:offline:761983003655405628>  | **Çevrimdışı**`)
        ...
        .setFooter(`Focus Bot | Kullanıcı Bilgi Sistemi`)
