...
const sayfa = [`**${message.guild.name} | Sunucu Ayarları**\n**Botun Prefixi :** \`${p}\n**Reklam Engel:** ${db.fetch(`reklamengel_${message.guild.id}`) ? `<:acik:756097249133723668>` : `<:kapali:756096841367420989>` }\n**Küfür Engel:** ${db.fetch(`kufurE_${message.guild.id}`) ? `<:acik:756097249133723668> ` : `<:kapali:756096841367420989>` }`] 
