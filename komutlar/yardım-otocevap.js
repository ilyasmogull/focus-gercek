...
.setColor('BLUE') 
.setAuthor(`Focus Oto Cevap Komutları`, client.user.avatarURL())
.setDescription(`<a:pirate:749380925619437619> Focus botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
