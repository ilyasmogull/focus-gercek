...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:hypesquad1:761965318356336710>  **Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.channel.send(`<a:hypesquad1:761965318356336710>  **Bu özellik zaten kapalı! :wink: **`)
 
 
  message.channel.send(`<a:hypesquad1:761965318356336710>  **Kayıt Sistemi başarılı bir şekilde kapatıldı.**`)
