...
const words = ['youtube.com/matadors','matador','çikolata', 'aggsy', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'öldür', 'sonsuzluk', 'gerçek'];
...
exports.config = {
name: "yazan-kazanır",
aliases: ["ilk-yazan-kazanır", "yazankazanır"]
}